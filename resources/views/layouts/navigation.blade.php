        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                   @if(Session::get('current_nav') === 'dashboard')
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @if(Session::get('current_nav') === 'inventories')
                    <x-nav-link :href="route('inventories')" :active="request()->routeIs('inventories')">
                        {{ __('Inventories') }}
                    </x-nav-link>
                    @else
                    <x-nav-link :href="route('inventories')" >
                        {{ __('Inventories') }}
                    </x-nav-link>
                    @endif
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @if(Session::get('current_nav') === 'transactions')
                    <x-nav-link :href="route('transactions')" :active="request()->routeIs('transactions')">
                        {{ __('Transactions') }}
                    </x-nav-link>
                    @else
                    <x-nav-link :href="route('transactions')" >
                        {{ __('Transactions') }}
                    </x-nav-link>
                    @endif
                ...
                {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    @if(Session::get('current_nav') === 'customers')
